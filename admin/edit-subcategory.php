...
<option value="<?php echo $all->getCategoryId();?>"><?php echo $all->getCategory(); ?></option>
...
?>
<option value="<?php echo $all->getCategoryId();?>"><?php echo $result['categoryName'];?></option>
<?php } }?>
</select>
</div>
</div>
...
<div class="controls">
<input type="text" placeholder="Enter category Name"  name="subcategory" value="<?php echo  htmlentities($row['subcategoryName']);?>" class="span8 tip" required>
</div>
</div>
