...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
								...
								<li><a href="manage-seller.php"><i class="menu-icon icon-tasks"></i> Manage Seller </a></li>
								...
								<!-- <li><a href="manage-seller.php"><i class="menu-icon icon-table"></i>Manage Owner</a></li> -->
