...
if(isset($_POST['submit']))
{
	...
	$productscharge=$_POST['deliveryCharge'];
	...
	$sql=mysqli_query($con,"insert into products(category,subcategory,productName,productPrice,productDescription,deliveryCharge,productImage,productImage2,productImage3,priceBeforeDiscount,postingDate) values(
	'$category','$subcat','$productname','$productprice','$productdescription','$productscharge','$productimage1','$productimage2','$productimage3','$productpricebd','$date')");
...
<div class="controls">
<input type="text"    name="deliveryCharge"  placeholder="Enter Product Shipping Charge" class="span8 tip" required>
</div>
</div>
