...
$sql=mysqli_query($con,"insert into category(categoryName,categoryDescription,creationDate) values('$category','$description','$date')");
...
<head>
	...
	<title>Admin| Product Owner</title>
...
<div class="controls">
<input type="text" placeholder="Enter  Firstname"  name="category" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text" placeholder="Enter Middlename"  name="category" class="span8 tip" required>
</div>
</div>
