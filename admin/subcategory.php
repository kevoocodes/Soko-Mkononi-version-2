...
if(isset($_POST['submit']))
{
	...
	$date = date('Y-m-d');
$sql=mysqli_query($con,"insert into subCategory(categoryId,subcategoryName,dateCreated) values('$category','$subcat','$date')");
							...
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									while($row=mysqli_fetch_array($query))
									{
										...
										$sql =  $con->query("SELECT  * FROM category WHERE  id = '$catid'");
										$fetch = $sql->fetch_array();

									?>									
										<tr>
											<td><?php echo htmlentities($cnt);?></td>
											<td><?php echo htmlentities($fetch['categoryName']); ?></td>
											<td><?php echo htmlentities($row['subcategoryName']);?></td>
											<td><?php echo date("M d, Y", strtotime(htmlentities($row['dateCreated'])));?></td>
											<td>
