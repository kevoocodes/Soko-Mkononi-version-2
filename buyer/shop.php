                ...
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                             <a href="shop.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" class="btn btn-sm text-dark p-0"><i class="fas fa-heart text-primary mr-1"></i></a>
                            <a href="shop.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                        </div>
                    </div>
                </div>
